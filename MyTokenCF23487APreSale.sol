...
import "./MyTokenCF23487A.sol";

contract MyTokenCF23487APreSale {
    MyTokenCF23487A public token;
    ...
    function MyTokenCF23487APreSale(
        MyTokenCF23487A _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyTokenCF23487A(_token);
